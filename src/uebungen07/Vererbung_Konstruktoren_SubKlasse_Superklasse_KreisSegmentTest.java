...
public class Vererbung_Konstruktoren_SubKlasse_Superklasse_KreisSegmentTest {

	public static void main(String[] args) {
		
		SubKlasse_KreisSegment segment = new SubKlasse_KreisSegment(2, 180);
		
		System.out.println("Radius des KreisSegment: " + segment.getRadius());
		segment.radiusVergroessernUm(2);
		System.out.println("neuer Radius des KreisSegment: " + segment.getRadius());
		System.out.println("Winkel des KreisSegment: " + segment.winkel);
		System.out.println("Fläche des KreisSegment: " + segment.getFlaeche());
		System.out.println("Umfang des KreisSegment: " + segment.getUmfang());
