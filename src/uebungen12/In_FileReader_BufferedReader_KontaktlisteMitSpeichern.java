...
public class In_FileReader_BufferedReader_KontaktlisteMitSpeichern extends javax.swing.JFrame {
	...
	*/
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				In_FileReader_BufferedReader_KontaktlisteMitSpeichern inst = new In_FileReader_BufferedReader_KontaktlisteMitSpeichern();
	...
	public In_FileReader_BufferedReader_KontaktlisteMitSpeichern() {
		super();
		initGUI();
	}
