/* TODO 12.4.2.  eigene bemerkung (+ s.384)	
 * class SetPreferredSize_Plus_Klasse_Dimension
 * 
 * 
 ...
 *
 * 
 * SIEHE AUCH ANGEWANDT:					12.4.2.   ImageIO_Klasse_Basics_JFilechooser_Bildbetrachter		s.384,
 * 					&:			.9.3.(eigtl. 12.4.2.)   Jigloo_AnchorLayout_Basics_BspButton				s.385,  Eigenes Bsp.		
 *   
 */
