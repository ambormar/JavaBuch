/* TODO 12.4.1.   s.380, 	
 * class BildDateien_In_Buttons_setIcon_setRolloverIcon_setPressedIcon
 * 
 ...
 * 			  		
 * 
 * 	MÖGLICHE SCHALTFLÄCHENZUSTÄNDE BEI BUTTONS:
 * 
 * 		PROPERTIE-EIGENSCHAFT:		METHODE IM CODE:			BEDEUTUNG:										BEMERKUNGEN:
 * 
 * 		icon						setIcon()					(bild) bei normalzustand des buttons
 * 		rolloverIcon				setRolloverIcon()			bei mauszeiger über schaltfläche
 * 		pressedIcon					setPressedIcon()			bei gedrückter schaltfläche
 * 		disabledIcon				setDisabledIcon()			bei deaktivierter schaltfläche					button-bild wird auch schon standardmässig ausgegraut dargestell
 * 		disabledSelectedIcon		setDisabledSelectedIcon()	bei deaktivierter gedrückter schaltfläche 		sinnvoll bei toggle-buttons (kippschalter)
 * 		rolloverSelectedIcon		setRolloverSelectedIcon()	bei mauszeiger über gedrückter schaltfläche		sinnvoll bei toggle-buttons 
 * 		selectedIcon				setSelectedIcon()			bei gedrückter schaltfläche						sinnvoll bei toggle-buttons
 * 
 * 
 ...
 * 				{	
 * 					...
 * 					jButton1.setIcon(new ImageIcon(getClass().getClassLoader().getResource("gui_images/HPH.JPG")));
...
public class BildDateien_In_Buttons_setIcon_setRolloverIcon_setPressedIcon extends javax.swing.JFrame {
	...
	*/
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				BildDateien_In_Buttons_setIcon_setRolloverIcon_setPressedIcon inst = new BildDateien_In_Buttons_setIcon_setRolloverIcon_setPressedIcon();
	...
	public BildDateien_In_Buttons_setIcon_setRolloverIcon_setPressedIcon() {
		super();
		initGUI();
	}
