...
public abstract class Abstract_Gebaude {
	public double quadratmeter;			// variabeln, vorgegeben für die vererbung, abstractklasse kann variablen-wert speichern, muss aber nicht

	public abstract double getQuadratmeter();	// nur methoden-köpfe um methoden vorzugeben ohne Implementierung/rumpf
	
	public void setQuadratmeter(double quadratmeter) { // methoden können auch in der abstract klasse schon implementiert werden (werden dann normal vererbt)
