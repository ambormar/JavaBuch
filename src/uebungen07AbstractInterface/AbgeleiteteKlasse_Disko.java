...
public class AbgeleiteteKlasse_Disko extends Abstract_Gebaude implements Interface_Stromversorgung {

	// methode wird vom StromversorgungInterface aufgezwungen, muss hier implementiert(programmiert) werden
	public double getStromverbrauch() {
		// beliebige implementierung /programmierung
		return 0;
	}

	// methode wird vom GebaudeAbstract aufgezwungen, muss hier implementiert(programmiert) werden
