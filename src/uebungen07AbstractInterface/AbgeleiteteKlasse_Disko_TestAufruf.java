...
public class AbgeleiteteKlasse_Disko_TestAufruf {

	public static void main(String[] args) {
		AbgeleiteteKlasse_Disko d = new AbgeleiteteKlasse_Disko();
		d.setQuadratmeter(15);
		System.out.println("Quadratmeter: " + d.getQuadratmeter());
		System.out.println("Stromverbrauch: " + d.getStromverbrauch());
	}
}
